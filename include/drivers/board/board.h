...
#define SET_SW(f) WRITE_GPIO(GPIO_SWs,f)
#define SET_LED(f) WRITE_GPIO(GPIO_LEDs,f)
#define SET_SegEn(f)  M_PSP_WRITE_REGISTER_32(SegEn_ADDR, f)
#define SET_SegDig(f) M_PSP_WRITE_REGISTER_32(SegDig_ADDR, f)
...
#define ROM_SIZE               ((uint32_t)0x04000000)
#define ROM_END                ((uint32_t)(ROM_START + ROM_SIZE))

#define RAM_START              (0x04000000)
#define RAM_SIZE               ((uint32_t)0x04000000)
